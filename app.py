...
def generate_tickets_weighted(counter, n_tickets):
    ...
    while len(tickets) < n_tickets:
        ...
        # Bonus number NOT in main numbers
...
def generate_smart_tickets(n_tickets, fixed_nums, exclude_nums, overdue_nums):
    ...
    while len(tickets) < n_tickets:
        ...
        # Fill rest randomly excluding excluded numbers
...
if uploaded_file:
    try:
        ...
        if numbers_df is None:
            ...
            # Number pair frequency analysis
            pair_counts = Counter()
            ...
            if gen_method == "Hot/Cold Weighted":
                ...
                overdue_nums = {}  # Could add overdue logic here if needed
